...
async function main(): Promise<void> {
  ...
  assert(readme.includes('Apple Command Line Tools') && readme.includes('~/.zprofile') && readme.includes('~/.zshrc') && readme.includes('`node`, `npm`, `thinkless`, `codex`, `claude`, and `gh`') && readme.includes('clean zsh login and interactive shells') && readme.includes('export PATH=... && thinkless'), 'README must document first-run CLT waiting and full zsh command exposure');
